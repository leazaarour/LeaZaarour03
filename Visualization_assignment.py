...
df= pd.read_csv('/Users/leazaarour/Desktop/who_suicide_statistics.csv')

@st.cache(allow_output_mutation= True)
def load_data(nrows):
    df= pd.read_csv('/Users/leazaarour/Desktop/who_suicide_statistics.csv', nrows= nrows)
...
df1=pd.read_csv('/Users/leazaarour/Desktop/us-cities-top-1k.csv')
